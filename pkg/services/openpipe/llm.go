...
const DefaultLLMModel = "gpt-4.1"

// LLMService implements services.LLMService using OpenPipe's OpenAI-compatible chat API.
type LLMService struct {
	client *openai.Client
	model  string
}

// NewLLMService creates an OpenPipe LLM service.
